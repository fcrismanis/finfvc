...
- Sistema FinFVC em operação, com integração Pluggy e Supabase.
...
1. Confirmar que todas as contas/cartões relevantes estão conectados via Pluggy ou lançados manualmente no FinFVC.
...
4. Gerar o primeiro relatório mensal em `../relatorios/`.
